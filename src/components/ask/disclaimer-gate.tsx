...
/* ════════════════════════════════════════════════════════════════
   ...
   Shows ONCE after first sign-in. User must:
   1. Scroll through full risk disclosure
   2. Check 4 acknowledgment checkboxes
   3. Click "I Accept" button
   
   Saves acceptance timestamp to DB via /api/user/disclaimer
   Only then does the War Room become accessible.
   ════════════════════════════════════════════════════════════════ */
...
const CHECKBOXES = [
  {
    id: 'not_advice',
    text: 'I understand that TradeYodha is NOT a registered investment advisor and does not provide financial, investment, or trading advice.',
  },
  {
    id: 'ai_mistakes',
    text: 'I understand that AI models, machine learning predictions, and automated analysis can and will make mistakes. Past performance does not guarantee future results.',
  },
  {
    id: 'risk_loss',
    text: 'I understand that trading involves substantial risk of loss. I may lose some or all of my invested capital. I will only trade with money I can afford to lose.',
  },
  {
    id: 'own_decisions',
    text: 'I accept full responsibility for my own trading decisions and their financial consequences. TradeYodha is not liable for any losses I incur.',
  },
];
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8 }}>
              ...
              <p style={{ marginBottom: 16 }}>
                <strong style={{ color: 'rgba(255,255,255,0.85)' }}>AI & Machine Learning Limitations:</strong> The analysis, predictions, thesis statements, confluence signals, and trade levels generated by TradeYodha are produced by artificial intelligence and machine learning models. These models are probabilistic tools that <strong style={{ color: '#ff5252' }}>can and will make errors</strong>. Our ML model has an approximately 59% win rate — meaning it is <strong style={{ color: '#ff5252' }}>wrong roughly 40% of the time</strong>. Model outputs should never be treated as certainties or guarantees.
              </p>

              <p style={{ marginBottom: 16 }}>
                <strong style={{ color: 'rgba(255,255,255,0.85)' }}>Data Accuracy:</strong> Real-time market data, options flow, dark pool prints, gamma levels, and other information displayed on this platform may contain errors, delays, or inaccuracies. Data is sourced from third-party providers and may not reflect the most current market conditions.
              </p>

              <p style={{ marginBottom: 16 }}>
                <strong style={{ color: 'rgba(255,255,255,0.85)' }}>Trading Risk:</strong> Trading securities, options, and other financial instruments involves <strong style={{ color: '#ff5252' }}>substantial risk of loss</strong> and is not suitable for all investors. You may lose some or all of your invested capital. Past performance of the platform, its models, or any analysis does not guarantee future results.
              </p>

              <p style={{ marginBottom: 0 }}>
                <strong style={{ color: 'rgba(255,255,255,0.85)' }}>Your Responsibility:</strong> If you choose to execute trades based on information from TradeYodha, you do so <strong style={{ color: 'rgba(255,255,255,0.85)' }}>entirely at your own risk</strong>. You are solely responsible for your trading decisions and their financial consequences. Always consult with a qualified financial advisor before making investment decisions. Never trade with money you cannot afford to lose.
              </p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <Link href="/terms" target="_blank" style={{
              fontSize: 11, color: 'rgba(0,229,255,0.7)', display: 'flex', alignItems: 'center', gap: 4,
              textDecoration: 'none',
            }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              transition: 'all 0.3s',
              transform: allChecked ? 'scale(1)' : 'scale(0.98)',
            }}
          >
            <Shield style={{ width: 18, height: 18 }} />
            {submitting ? 'Saving...' : allChecked ? 'I Accept — Enter the War Room' : 'Check all boxes to continue'}
          </button>
          <p style={{
